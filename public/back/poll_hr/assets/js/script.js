...
function showTab(n) {
  ...
  if (n == (x.length - 1)) {
    ...
    document.getElementById("sendPollBtn").style.display = "inline";
  } else {
    document.getElementById("nextBtn").style.display = "inline";
    document.getElementById("sendPollBtn").style.display = "none";
    document.getElementById("nextBtn").innerHTML = "<i class='fas fa-chevron-left'></i>";
  }
