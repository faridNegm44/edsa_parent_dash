            ...
            <div class="row row-xs">
                ...
                <div class="col-md-6">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input class="form-control" id="TheName" name="TheName" placeholder="إسم الطالب" type="text "value="{{ $find['TheName'] }}">
                    </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input class="form-control" id="TheEmail" name="TheEmail" placeholder="البريد الإلكتروني" type="text "value="{{ $find['TheEmail'] }}">
                    </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input class="form-control" id="ThePhone" name="ThePhone" placeholder="واتساب" type="text "value="{{ $find['ThePhone'] }}">
                    </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <textarea class="form-control" id="TheExplain" name="TheExplain" placeholder="السجل الدراسي" rows="5" style="resize: none;">{{ $find['TheExplain'] }}</textarea>
                    </div>
