                ...
                <div class="row row-xs">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input class="form-control" id="TheName" name="TheName" placeholder="اسم الطالب" type="text" />
                        </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input class="form-control" id="TheEmail" name="TheEmail" placeholder="البريد الإلكتروني" type="email" value="" >
                        </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input class="form-control" id="ThePhone" name="ThePhone" placeholder="واتساب الطالب إن وجد" type="text">
                        </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <textarea class="form-control" id="TheExplain" name="TheExplain" placeholder="السجل الدراسي للطالب. علي سبيل المثال الطالب محول من لغات إلي عربي أو الطالب محول من إنترناشيونال" value="" rows="5" style="resize: none;"></textarea>
                        </div>
                ...
                <div class="row row-xs">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input class="form-control" id="TheEmail" name="TheEmail" placeholder="البريد الإلكتروني" type="email" value="{{ auth()->user()->email }}" >
                        </div>
                        <p class="errors" id="errors-TheEmail"></p>
                    </div>
...
<script>
    $('.modal-title').html("نموذج إضافة طالب");
