                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group mg-b-20">
                                ...
                                <select name="problem_type" id="problem_type" class="form-control">
                                    <option value="">---</option>
                                    <option {{ $find['problem_type'] == "شكوي من الإدارة" ? 'selected' : null }} value="شكوي من الإدارة">شكوي من الإدارة</option>
                                    <option {{ $find['problem_type'] == "شكوي من مدرس" ? 'selected' : null }} value="شكوي من مدرس">شكوي من مدرس</option>
                                    <option {{ $find['problem_type'] == "نقل إلي جروب أخر" ? 'selected' : null }} value="نقل إلي جروب أخر">نقل إلي جروب أخر</option>
                                    <option {{ $find['problem_type'] == "الإشتراك في مادة أخري" ? 'selected' : null }} value="الإشتراك في مادة أخري">الإشتراك في مادة أخري</option>
                                    <option {{ $find['problem_type'] == "إقتراحات" ? 'selected' : null }} value="إقتراحات">إقتراحات</option>
                                    <option {{ $find['problem_type'] == "أخري" ? 'selected' : null }} value="أخري">أخري</option>
                                </select>
                        ...
                        <div class="col-md-9">
                            ...
                            <div class="form-group mg-b-20">
                                ...
                                <textarea class="summernote form-control" name="problem" id="problem">
                                    {!! $find['problem'] !!}
                                </textarea>
                    ...
                    <div class="pd-30 pd-sm-40 bg-gray-100">
                        <div class="row row-xs">
                            ...
                            <div class="col-md-9" style="margin-bottom: 10px;">
                                <textarea class="form-control" name="comment" id="comment" placeholder="أضف تعليق" rows="4" style="resize: vertical;">
