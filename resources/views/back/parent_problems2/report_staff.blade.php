        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="pd-30 pd-sm-40 bg-gray-100">
                    <form action="{{ url('dashboard/parent_problems/report/staff_post') }}" method="post">
                        @csrf
                        <div class="row row-xs">
                            <div class="col-md-5">
                                <select name="staff_id" id="staff_id" class="form-control select2_select2" required style="width: 100%;">
