                ...
                <div class="panal_body" style="padding: 40px 20px;">
                    <div style="position: relative;">
                        <span class="card-title mg-b-0" style="padding-top: 10px;">
                            ...
                            <br>
                            <br>
                            <span style="color: red;font-weight: bold;margin: 0px 10px;text-decoration: underline;">من: {{ Carbon\Carbon::parse($from)->format('Y-m-d h:i') }}</span>
                            <span style="color: red;font-weight: bold;margin: 0px 10px;text-decoration: underline;">إلي: {{ Carbon\Carbon::parse($to)->format('Y-m-d h:i') }}</span>
                        </span>
