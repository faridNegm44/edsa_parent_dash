...
@section('title') أولياء الأمور @endsection
...
@section('footer')
    ...
    <script>
        $('#example2').DataTable({
            ...
            ajax: "{{ url('dashboard/parents/datatable_parents') }}",
            columns: [
                {data: 'name', name: 'name'},
                {data: 'email', name: 'email'},
                {data: 'phone', name: 'phone'},
                {data: 'phone2', name: 'phone2'},
                {data: 'nat_id', name: 'nat_id'},
...
@section('content')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="left-content">
            <h4 class="content-title mb-2">أولياء الأمور</h4>
            ...
            <div class="card-header pb-0 pd-t-25">
                <div class="d-flex justify-content-between">
                    ...
                    {{-- <div class="col-xs-6 d-flex">
                        <a class="btn btn-primary btn-icon btn-sm text-white mr-2" href="{{ url('dashboard/parent/register') }}"><i class="fe fe-plus"></i></a>
                    </div> --}}
