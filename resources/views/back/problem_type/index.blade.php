...
@section('title') تصنيف الطلبات @endsection
...
@section('footer')
    ...
    <script>
        $('#example2').DataTable({
            ...
            ajax: "{{ url('dashboard/problem_types/datatable_problem_types') }}",
            columns: [
                {data: 'name', name: 'name'},
                {data: 'rate', name: 'rate'},
                {data: 'show_to_parent', name: 'show_to_parent'},
    ...
    @include('back.problem_type.delete');
...
@section('content')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="left-content">
            <h4 class="content-title mb-2">تصنيف الطلبات</h4>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ url('dashboard') }}">الرئيسيه</a></li>
                    <li class="breadcrumb-item active" aria-current="page">تصنيف الطلبات</li>
                </ol>
            </nav>
        </div>
    </div>
            ...
            <div class="card-header pb-0 pd-t-25">
                <div class="d-flex justify-content-between">
                    ...
                    <div class="col-xs-6 d-flex">
                        <a class="btn btn-primary btn-icon btn-sm text-white mr-2 modal-effect bt_modal" act="{{ url('dashboard/problem_types/create') }}" data-effect="effect-sign" data-toggle="modal" href="#modaldemo8"><i class="fe fe-plus"></i></a>
                    </div>
                </div>
            </div>
            <div class="card-body">
