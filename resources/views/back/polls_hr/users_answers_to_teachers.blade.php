...
@section('footer')
    ...
    <script>
        $('#example2').DataTable({
            ...
            ajax: `{{ url('dashboard/polls_hr/users_answers_to_teachers_datatable') }}`,
            columns: [
                {data: 'user', name: 'user'},
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table text-md-nowrap table-striped table-bordered text-center" id="example2" style="width: 100%;">
                        <thead>
                            <tr>
                                <th style="width: 7.5%;">المستخدم</th>
                                <th style="width: 7.5%;">وقت التقييم</th>
                                <th style="width: 7.5%;">المجموعة</th>
                                <th style="width: 7.5%;">المدرس</th>
                                <th style="width: 20%;">السؤال</th>
                                <th style="width: 5%;">قيمة السؤال</th>
                                <th style="width: 5%;">قيمة الإجابة</th>
                                <th style="width: 20%;">الإجابة</th>
                                <th style="width: 10%;">ن ج من سؤال</th>
                            </tr>
                        </thead>
                    </table>
                </div>
