...
<head>
    ...
    <title>تقرير استبيان لولي أمر يخص جروبات المدرسين: {{ $parent }} - {{ date('Y-m-d h:i a') }}</title>
        ...
        <div class="">
            <div class="invoice-title">
                <h4 class="text-center" style="font-weight: bold;">
                    تقرير استبيان لولي أمر يخص جروبات المدرسين
                    <br>
                    <br>
                    <p>ولي أمر: {{ $parent }}</p>
                </h4>
                        ...
                        <thead style="font-weight: bold;">
                            @if ($get_polls_users_to_hr[0]['question_type'] != 'radio')
                                <tr>
                                    ...
                                    <td class="text-center" style="font-weight: bold;width: 35x%;"><strong>السؤال</strong></td>
                                    <td class="text-center" style="font-weight: bold;width: 25%;"><strong>الإجابة</strong></td>
                                </tr>
                            @else
                                <tr>
                                    <td class="text-center" style="font-weight: bold;width: 15%;"><strong>المجموعة</strong></td>
                                    <td class="text-center" style="font-weight: bold;width: 10%;"><strong>مدرس/وقت التقييم</strong></td>
                                    <td class="text-center" style="font-weight: bold;width: 35%;"><strong>السؤال</strong></td>
                                    <td class="text-center" style="font-weight: bold;width: 25%;"><strong>الإجابة</strong></td>
                            ...
                            @foreach ($get_polls_users_to_hr as $key => $item)
                                <tr>
                                    ...
                                    <td class="text-center answer_percentage_from_question">  
                                        @if ($item->answer_percentage > 0 && $item->question_percentage > 0)
