...
class StudentController extends Controller
{
    ...
    public function attendance_and_absence_report_for_students_post(Request $request)
    {
        ...
        $all_data = DB::table('tbl_groups_classes_att')
                        ->leftJoin('tbl_groups_classes', 'tbl_groups_classes_att.ClassID', 'tbl_groups_classes.ID')
                        ->leftJoin('tbl_groups', 'tbl_groups_classes.GroupID', 'tbl_groups.ID')
                        ->leftJoin('tbl_years_mat', 'tbl_groups.YearID', 'tbl_years_mat.ID')
                        ->leftJoin('tbl_students', 'tbl_groups_classes_att.StudentID', 'tbl_students.ID')
                        ->leftJoin('tbl_teachers', 'tbl_groups_classes_att.TeacherID', 'tbl_teachers.ID')
